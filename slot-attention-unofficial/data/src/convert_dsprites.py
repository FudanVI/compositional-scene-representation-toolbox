...
def main():
    ...
    path_in = os.path.join(args.folder_in, 'multi_dsprites', 'multi_dsprites_colored_on_grayscale.tfrecords')
    dataset = multi_dsprites.dataset(path_in, 'colored_on_grayscale', map_parallel_calls=args.num_parallel)
