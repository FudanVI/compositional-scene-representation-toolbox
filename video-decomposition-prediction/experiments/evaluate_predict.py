...
for observed_views in [6, 7, 8, 9]:
    ...
    for name_data, checkpoint in zip(name_list, checkpoint_list):
        ...
        for phase in phase_list:
            ...
            for mode in [1, 2]:
                results = {}
                with h5py.File(os.path.join(checkpoint, '{}_m{}_o{}_q{}.h5'.format(phase, mode, observed_views,
                                                                                   10 - observed_views)), 'r') as f:
                    for key in f['Q']:
                        if key in ['pres']:
                ...
                query_view_list = [n for n in [1, 2, 4] if n <= 10 - observed_views]
                for query_view in query_view_list:
                    print(
    ...
    with open('predict_metrics_{}.pkl'.format(observed_views), 'wb') as f:
